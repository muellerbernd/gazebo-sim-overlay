self: super: {
  ...
  ignition = {
    ...
    tools2 = self.libsForQt5.callPackage ./ignition/tools/2.nix {};
    tools = self.ignition.tools2;
    ...
    rendering8 = self.libsForQt5.callPackage ./ignition/rendering/8.nix {};
    rendering = self.ignition.rendering8;
    gui8 = self.libsForQt5.callPackage ./ignition/gui/8.nix {};
    gui = self.ignition.gui8;
    sensors8 = self.libsForQt5.callPackage ./ignition/sensors/8.nix {};
    sensors = self.ignition.sensors8;
    launch7 = self.libsForQt5.callPackage ./ignition/launch/7.nix {};
    launch = self.ignition.launch7;
    sim8 = self.libsForQt5.callPackage ./ignition/sim/8.nix {};
    sim = self.ignition.sim8;
  };
